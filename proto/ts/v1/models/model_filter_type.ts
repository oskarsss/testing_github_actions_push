...
export enum FilterModel_FilterID {
    ...
    FILTER_BROKER = 36,
    /**
     * @generated from protobuf enum value: FILTER_BROKER_CREATED_AT = 37;
     */
    FILTER_BROKER_CREATED_AT = 37,
    /**
     * @generated from protobuf enum value: FILTER_CUSTOMER = 38;
     */
    FILTER_CUSTOMER = 38,
    /**
     * @generated from protobuf enum value: FILTER_CUSTOMER_CREATED_AT = 39;
     */
    FILTER_CUSTOMER_CREATED_AT = 39,
    /**
     * @generated from protobuf enum value: FILTER_FUEL_TRANSACTION_VERIFIED = 40;
     */
    FILTER_FUEL_TRANSACTION_VERIFIED = 40,
    /**
     * @generated from protobuf enum value: FILTER_FUEL_SETTLEMENT_STATUS = 41;
     */
    FILTER_FUEL_SETTLEMENT_STATUS = 41,
    /**
     * @generated from protobuf enum value: FILTER_TOLL_SETTLEMENT_STATUS = 42;
     */
    FILTER_TOLL_SETTLEMENT_STATUS = 42,
    /**
     * @generated from protobuf enum value: FILTER_PAYOUT_STATUS = 43;
     */
    FILTER_PAYOUT_STATUS = 43,
    /**
     * @generated from protobuf enum value: FILTER_MANIFEST_STATUS = 44;
     */
    FILTER_MANIFEST_STATUS = 44,
    /**
     * @generated from protobuf enum value: FILTER_SERVICE_LOG_PROVIDER = 45;
     */
    FILTER_SERVICE_LOG_PROVIDER = 45,
    /**
     * @generated from protobuf enum value: FILTER_SERVICE_LOG_TYPE = 46;
     */
    FILTER_SERVICE_LOG_TYPE = 46
}
...
class FilterModel_Filter$Type extends MessageType<FilterModel_Filter> {
    constructor() {
        super("FilterModel.Filter", [
            { no: 1, name: "filter_id", kind: "enum", T: () => ["FilterModel.FilterID", FilterModel_FilterID] },
            { no: 2, name: "counts", kind: "map", K: 9 /*ScalarType.STRING*/, V: { kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 2 /*LongType.NUMBER*/ } },
            { no: 3, name: "amounts", kind: "map", K: 9 /*ScalarType.STRING*/, V: { kind: "scalar", T: 9 /*ScalarType.STRING*/ } }
        ]);
    }
    create(value?: PartialMessage<FilterModel_Filter>): FilterModel_Filter {
        ...
        message.amounts = {};
        if (value !== undefined)
            reflectionMergePartial<FilterModel_Filter>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: FilterModel_Filter): FilterModel_Filter {
    ...
    private binaryReadMap2(map: FilterModel_Filter["counts"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof FilterModel_Filter["counts"] | undefined, val: FilterModel_Filter["counts"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for field FilterModel.Filter.counts");
            }
        }
        map[key ?? ""] = val ?? 0;
    }
    private binaryReadMap3(map: FilterModel_Filter["amounts"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof FilterModel_Filter["amounts"] | undefined, val: FilterModel_Filter["amounts"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field FilterModel.Filter.amounts");
            }
        }
        map[key ?? ""] = val ?? "";
    }
    internalBinaryWrite(message: FilterModel_Filter, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* FilterModel.FilterID filter_id = 1; */
        if (message.filterId !== 0)
            writer.tag(1, WireType.Varint).int32(message.filterId);
        /* map<string, int64> counts = 2; */
        for (let k of globalThis.Object.keys(message.counts))
            writer.tag(2, WireType.LengthDelimited).fork().tag(1, WireType.LengthDelimited).string(k).tag(2, WireType.Varint).int64(message.counts[k]).join();
        /* map<string, string> amounts = 3; */
        for (let k of globalThis.Object.keys(message.amounts))
            writer.tag(3, WireType.LengthDelimited).fork().tag(1, WireType.LengthDelimited).string(k).tag(2, WireType.LengthDelimited).string(message.amounts[k]).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
