...
export default function PayoutBankAccountTo({ bankAccount }: Props) {
    const { t } = useAppTranslation('modals');
    return (
        <PayoutComponents.ContentTabContainer>
            <PayoutComponents.ContentTabTitle>
                {t('settlements.edit_settlement.payout.labels.to')}
            </PayoutComponents.ContentTabTitle>
            ...
            <PayoutComponents.ContentTabRow>
                <PayoutComponents.ContentTabText>
                    {t('settlements.edit_settlement.payout.labels.routing_number')}
                </PayoutComponents.ContentTabText>
