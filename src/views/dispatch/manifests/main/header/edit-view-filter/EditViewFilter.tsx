...
import DragDropFilter from './DragDropFilter';
...
type Props = {
    view: ManifestView;
    views: ManifestView[];
    updateViewsAction: (views: ManifestView[]) => void;
...
function EditViewFilter({
    ...
    const [sortedViews, setSortedViews] = useState<ManifestView[]>(views);
    ...
    const onSorting = (views: ManifestView[]) => {
