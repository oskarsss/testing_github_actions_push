...
import { DocumentContext, DocumentContextType } from '@/@core/components/documents/Documents';
...
function WarrantyDocument({
    ...
    const contextValue: DocumentContextType = useMemo(
        ...
        [document, entityType, entityId, t]
    );
    ...
    return document ? (
        <DocumentContext.Provider value={contextValue}>
            <DocumentContent
                ...
                fileName={`${t('core:documents.title')}_${document.documentType?.title || ''}`}
            />
...
export default memo(WarrantyDocument);
